...
<section class="row my-3">
    <section class="col-12">
        ...
        <form method="post" action="http://localhost/PHPTuto/0.tutorial/article/update/<?php echo $id; ?>"
            ...
            <div class="form-group">
                <img style="width: 100px;" src="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/PHPTuto/0.tutorial/'
                    . $article['image']; ?>" alt="">
                <hr/>

            ...
            <form method="post" action="http://localhost/PHPTotu/0.tutorial/menu/update/<?php echo $id ?>">
                ...
                <div class="form-group">
                    ...
                    <select name="parent_id" id="parent_id" class="form-control" autofocus>
                        ...
                        <?php
                        foreach ($menus as $selectMenus) {
                            if ($menu['id'] != $selectMenus['id']) {
                                ?>
                                <option value="<?php echo $selectMenus['id'] ?>" <?php if ($menu['parent_id'] == $selectMenus['id']) echo 'selected' ?> ><?php echo $selectMenus['name'] ?></option>
                                <?php
                            }
                        }
                        ?>

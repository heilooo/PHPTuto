...
<section class="table-responsive">
    <table class="table table-striped table-sm">
        ...
        <tr>
            <td>
                <a href="http://localhost/PHPTuto/0.tutorial/comment/show/<?php echo $comment['id'] ?>"><?php echo $comment['id'] ?></a>
            </td>
            ...
            <td>
                ...
                if ($comment['status'] == 'seen') {
                    ...
                    ?>
                    <a role="button" class="btn btn-sm btn-warning text-white"
                       href="http://localhost/PHPTuto/0.tutorial/comment/approved/<?php echo $comment['id'] ?>">click to not approved</a>
                <?php }
                ?>
            </td>
        </tr>

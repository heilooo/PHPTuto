        ...
        <section class="col-12">
            ...
            if ($comment['status'] == 'seen') {
                ...
                <a class="btn btn-sm btn-success"
                   href="http://localhost/admin-panel/comment/approved/<?php echo $comment['id'] ?>">click to
                    approved</a>
                <?php
            } else {
                ?>
                <a class="btn btn-sm btn-warning"
                   href="http://localhost/admin-panel/comment/approved/<?php echo $comment['id'] ?>">click to not
                    approved</a>

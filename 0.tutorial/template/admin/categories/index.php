...
?>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a role="button" href="category/create" class="btn btn-sm btn-success">create</a>
        </div>
    </div>
...
foreach ($categories as $category) { ?>
            <tr>
                ...
                <td>
                    ...
                    <a role="button" href="http://localhost/PHPTuto/0.tutorial/category/delete/<?php echo $category['id'];
                    ?>" class="btn btn-sm

    ...
    <section class="app bg-map">
        <section class="footer-row">
            <section class="footer-col">
                <img class="footer-logo" src="http://localhost/PHPTuto/0.tutorial/<?php if (isset($setting['logo'])) echo $setting['logo'] ?>" alt="">
                <section class="clear-fix"></section>
                <p class="footer-p"><?php if (isset($setting['description'])) echo $setting['description'] ?></p>

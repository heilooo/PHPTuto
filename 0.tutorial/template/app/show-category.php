                ...
                <section class="main-crypto-mining-news">
                    ...
                    <?php foreach($articles as $article) {?>
                        <section class="main-news-w-50">
                            <article>
                                <img class="main-news-img" src="http://localhost/PHPTuto/0.tutorial/<?php echo $article['image']; ?>" alt="">
                                <h3 class="article-title">
                                    <a href="http://localhost/PHPTuto/0.tutorial/show-article/<?php echo $article['id']; ?>"><?php echo $article['title']; ?></a>
                                </h3>
                                <ul class="info-bar">

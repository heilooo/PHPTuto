            ...
            <section class="intro-row intro-h-2-3 mb-10x">
                ...
                if (isset($articles[0])) {
                    ...
                    <section class="intro-2-3-col intro-h-100 position-relative h-md-300px">
                        <a href="http://localhost/PHPTuto/0.tutorial/show-article/<?php echo $articles[0]['id']; ?>">
                            <section class="intro-2-3-item img-bg intro-h-100"
                                     style="background: url(http://localhost/PHPTuto/0.tutorial/<?php echo $articles[0]['image']; ?>) no-repeat center; background-size: cover;"></section>
                            <section class="intro-item-caption">
                                ...
                                <ul class="caption-info-bar">
                                    <li class="">by <b
                                                class="text-yellow"><?php echo $articles[0]['username']; ?></b> <?php echo date("M d,Y", strtotime($articles[0]['created_at'])) ?>
                                    </li>
                ...
                <section class="intro-1-3-col intro-h-100">
                    ...
                    if (isset($articles[1])) {
                        ...
                        <section class="intro-1-3-item intro-h-50 position-relative h-md-300px">
                            <a href="http://localhost/PHPTuto/0.tutorial/show-article/<?php echo $articles[1]['id']; ?>">
                                <section class="img-bg intro-h-100"
                                         style="background: url(http://localhost/PHPTuto/0.tutorial/<?php echo $articles[1]['image']; ?>) no-repeat center; background-size: cover;"></section>
                                <section class="intro-item-caption">
                                    <h3 class="caption-title">
                                    ...
                                    <ul class="caption-info-bar">
                                        ...
                                        <li><i class="fas fa-bolt text-yellow"></i> <?php echo $articles[1]['view']; ?>
                                        </li>
                    ...
                    if (isset($articles[2])) {
                        ...
                        ?>
                        <section class="intro-1-3-item intro-h-50 position-relative h-md-300px">
                            <a href="http://localhost/PHPTuto/0.tutorial/show-article/<?php echo $articles[2]['id']; ?>">
                                <section class="img-bg intro-h-100"
                                         style="background: url(http://localhost/PHPTuto/0.tutorial/<?php echo $articles[2]['image']; ?>) no-repeat center; background-size: cover;"></section>
                                <section class="intro-item-caption">
                                    <h3 class="caption-title">
                                    ...
                                    <ul class="caption-info-bar">
                                        ...
                                        <li><i class="fas fa-bolt text-yellow"></i> <?php echo $articles[2]['view']; ?>
                                        </li>
            ...
            <section class="intro-row intro-h-1-3">
                ...
                if (isset($articles[3])) {
                    ...
                    <section class="intro-1-3-col-item intro-h-100 position-relative h-md-300px">
                        <a href="http://localhost/PHPTuto/0.tutorial/show-article/<?php echo $articles[3]['id']; ?>">
                            <section class="img-bg intro-h-100"
                                     style="background: url(http://localhost/PHPTuto/0.tutorial/<?php echo $articles[3]['image']; ?>) no-repeat center; background-size: cover;"></section>
                            <section class="intro-item-caption">
                                <h3 class="caption-title">
                ...
                if (isset($articles[4])) {
                    ...
                    ?>
                    <section class="intro-1-3-col-item intro-h-100 position-relative h-md-300px">
                        <a href="http://localhost/PHPTuto/0.tutorial/show-article/<?php echo $articles[4]['id']; ?>">
                            <section class="img-bg intro-h-100"
                                     style="background: url(http://localhost/PHPTuto/0.tutorial/<?php echo $articles[4]['image']; ?>) no-repeat center; background-size: cover;"></section>
                            <section class="intro-item-caption">
                                <h3 class="caption-title">
                ...
                if (isset($articles[5])) {
                    ...
                    ?>
                    <section class="intro-1-3-col-item intro-h-100 position-relative h-md-300px">
                        <a href="http://localhost/PHPTuto/0.tutorial/show-article/<?php echo $articles[5]['id']; ?>">
                            <section class="img-bg intro-h-100"
                                     style="background: url(http://localhost/PHPTuto/0.tutorial/<?php echo $articles[5]['image']; ?>) no-repeat center; background-size: cover;"></section>
                            <section class="intro-item-caption">
                                <h3 class="caption-title">
                        ...
                        <section class="main-news-w-50">
                            <article>
                                <img class="main-news-img"
                                     src="http://localhost/PHPTuto/0.tutorial/<?php echo $popularArticle['image'] ?>"
                                     alt="">
                                ...
                                <ul class="info-bar">
                                    <li class=""><span class="text-muted">by</span> <a href="#"
                                                                                       class="color-black"><b><?php echo $popularArticle['username'] ?></b></a>
